...
# Hvordan kommer jeg ind på min Chromebook?

## Formål

Få styr på dit @meddel.dk-brugernavn, lav dit første kodeord og log ind på din Chromebook.

## Hvornår skal jeg bruge denne guide?

Brug guiden, når du er ny medarbejder, har fået en Chromebook og endnu ikke ved, hvilket brugernavn eller kodeord du skal bruge.
...
{% expandable title="Jeg kan ikke finde mit brugernavn" %}
Prøv igen via [login.ishoj.dk](https://login.ishoj.dk/) med MitID. Hvis brugernavnet stadig ikke vises, så skriv til EDB Pede på Aula.
{% endexpandable %}

{% expandable title="Kodeordet bliver afvist" %}
Tjek kravene: mindst 15 tegn, ingen Æ/Ø/Å og undgå navne eller andre personlige oplysninger.
{% endexpandable %}

## Relaterede guides

- [Den bedste måde at logge ind på](../login-koder-og-sikker-adgang/den-bedste-made-at-logge-ind-pa.md)
- [Skift din egen Chromebook-kode](../login-koder-og-sikker-adgang/sadan-skifter-du-din-egen-kode-pa-din-chromebook.md)
