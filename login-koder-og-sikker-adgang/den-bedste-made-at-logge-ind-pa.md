...
Vis den anbefalede måde at logge ind på Aula og andre undervisningsportaler med din @meddel.dk-konto.

## Hvornår skal jeg bruge denne guide?

Brug guiden, når du som medarbejder møder Unilogin/MitID/lokalt login og er i tvivl om, hvilken konto du skal vælge.
...
{% expandable title="Jeg kan ikke komme ind med Unilogin-vejen" %}
Prøv metode 2 gennem Ishøj Kommunes lokale IdP direkte. Husk at bruge brugernavn med @meddel.dk og samme kode som til Chromebook.
{% endexpandable %}

{% expandable title="Jeg har glemt min kode" %}
Brug guiden [Skift din egen Chromebook-kode](sadan-skifter-du-din-egen-kode-pa-din-chromebook.md).
{% endexpandable %}

## Relaterede guides

- [Ny medarbejder: Kom ind på din Chromebook](../chromebook-og-forste-dag/hvordan-kommer-jeg-ind-pa-min-chromebook.md)
- [Få OS2faktor til din Chromebook](fa-os2faktor-til-din-chromebook.md)
